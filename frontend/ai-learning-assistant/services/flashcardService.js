...
const getAllFlashcardSets = async () => {
  try {
    ...
    throw normalizeApiError(error, 'Failed to fetch flashcard sets');
  }
};
...
const getFlashcardsForDocument = async (documentId) => {
  try {
    ...
    throw normalizeApiError(error, 'Failed to fetch flashcards');
  }
};
...
const reviewFlashcard = async (cardId, cardIndex) => {
  try {
    ...
    throw normalizeApiError(error, 'Failed to review flashcard');
  }
};
const toggleStar = async (cardId) => {
    try {
      ...
      throw normalizeApiError(error, 'Failed to star flashcard');
    }
  };
  ...
  const deleteFlashcardSet = async (id) => {
    try {
      ...
      throw normalizeApiError(error, 'Failed to delete flashcards');
    }
  };
