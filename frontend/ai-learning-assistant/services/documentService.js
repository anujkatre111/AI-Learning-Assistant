...
const getDocuments = async () => {
    try{
        ...
        throw normalizeApiError(error, 'Failed to fetch documents');
    }
};
...
const uploadDocument = async (formData) => {
    try{
        ...
        throw normalizeApiError(error, 'Failed to upload document');
    }
};
...
const deleteDocument = async (id) => {
    try {
        ...
        throw normalizeApiError(error, 'Failed to delete document');
    }
}; 
...
const getDocumentById = async (id) => {
    try {
        ...
        throw normalizeApiError(error, 'Failed to fetch document details');
    }
};
