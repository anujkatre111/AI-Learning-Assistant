...
const generateFlashcards =  async (documentId, options) => {
    try{
        ...
        throw normalizeApiError(error, 'Failed to generate flashcards');
    }
};
...
const generateQuiz =  async (documentId, options) => {
    try{
        ...
        throw normalizeApiError(error, 'Failed to generate quiz');
    }
};
...
const generateSummary =  async (documentId) => {
    try{
        ...
        throw normalizeApiError(error, 'Failed to generate summary');
    }
};
...
const chat =  async (documentId, message) => {
    try{
        ...
        throw normalizeApiError(error, 'Failed to get AI response');
    }
};
...
const explainConcept =  async (documentId, concept) => {
    try{
        ...
        throw normalizeApiError(error, 'Failed to explain concept');
    }
};
...
const getChatHistory =  async (documentId) => {
    try{
        ...
        throw normalizeApiError(error, 'Failed to fetch chat history');
    }
};
